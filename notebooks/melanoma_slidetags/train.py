...
co_grn = RegulatoryFactory(
    colinks_path=base_dir + 'training_data_2025/snrna_human_melanoma_colinks.pkl',
    annot='cell_type_int'
)

adata = sc.read_h5ad(
    base_dir + 'training_data_2025/snrna_human_melanoma.h5ad')
...
star = SpaceTravLR(
    ...
    radius=400,
    contact_distance=50,
    save_dir=base_dir + 'lasso_runs/human_melanoma'
)
...
gf.genome_screen(
    save_to=base_dir + '/genome_screens/human_melanoma',
    n_propagation=4,
