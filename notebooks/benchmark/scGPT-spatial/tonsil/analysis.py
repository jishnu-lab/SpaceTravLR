...
adata.obsm['scGPT_spatial'] = sp_maps
adata.obsm['scGPT_spatial'].shape
...
gf = GeneFactory.from_json(
    adata, 
    '/ix/djishnu/shared/djishnu_kor11/scGPT_runs/tonsil_spatial/run_params.json', 
)

gf.load_betas(float16=True, obs_names=None)

os.makedirs('/ix/djishnu/shared/djishnu_kor11/genome_screens/human_tonsil_scGPT_spatial', exist_ok=True)
...
# # %%
# gf.genome_screen(
#     save_to=base_dir + '/genome_screens/human_tonsil_scGPT_spatial',
#     n_propagation=4,
