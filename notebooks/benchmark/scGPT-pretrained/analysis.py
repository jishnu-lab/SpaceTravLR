...
# %%
sp_maps = pd.read_parquet('/ix/djishnu/shared/djishnu_kor11/scGPT_outputs/tonsil_embeddings_pretrained.parquet')
sp_maps = sp_maps.reindex(adata.obs.index, axis=0).values

adata.obsm['scGPT_pretrained'] = sp_maps
adata.obsm['scGPT_pretrained'].shape
...
os.makedirs('/ix/djishnu/shared/djishnu_kor11/genome_screens/human_tonsil_scGPT_pretrained', exist_ok=True)
...
# %%
# gf.genome_screen(
#     save_to=base_dir + '/genome_screens/human_tonsil_scGPT_pretrained',
#     n_propagation=4,
...
# genes = [
#     'S1PR4', 'S1PR2', 'PDCD11', 'TRAF3', 'IL2', 'GATA2', 'STAT1', 'NFKBIZ', 'NFKBIB', 
